<template>
  ...
  <div
    ...
    <TitleBox />
    <!-- 主視覺 -->
    <div class="animate__animated animate__fadeInLeftBig laptop:w-5/12 h-table:w-10/12 h-full overflow-hidden relative"
      :class="[{ 'animate__delay-3s': getFirstEnter === true }]">
      <img class="transition-all ease-out z-30 absolute w-auto object-center" src="/img/kenny-logo.png" :style="{
      ...
      <img class="w-auto transition-all ease-out bg-white z-10 object-center" src="/img/about-bg-sp.jpg" ref="photo"
        :style="{
