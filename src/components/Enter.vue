<template>
  ...
  >
    <div class="self-center inline-block animate__animated animate__fadeOut animate__delay-4s">
      <svg
        class="enter-svg-obj svg-obj h-auto w-130px mx-auto animate__animated animate__rubberBand animate__delay-1s"
...
// // const { enterState, start, stop } = useTimeout(1000, { controls: true })
// const ready = useTimeout(2000, { controls: false })
