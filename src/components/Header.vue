<template>
      ...
      <nav
        ...
        <div class="flex items-center hover:animate-pulse header-logo">
          ...
          <router-link to="/" class="cursor-pointer">
            <svg class="header-svg-obj h-auto w-64px mobile:w-9" :class="{ active: modal === true }"
              xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" version="1.1" x="0px" y="0px" width="89px"
              height="98px" viewBox="-0.7 0 89 98" enable-background="new -0.7 0 89 98" xml:space="preserve">
              <defs>
  ...
  <div id="modal"
    ...
    <div class="w-full h-full modal-content relative m-auto overflow-hidden screens-h-900:overflow-y-auto">
      <div
        ...
        <ul
          ...
          <li>
            <router-link ref="scienceRef" to="/science" title="天文科普"
              class="font-serif tracking-wide-menu text-main-color-dark hover:text-sp-color-light duration-1000 h-table:text-8xl w-table:text-7xl large-pc:text-menu-title mobile:text-5xl screens-h-900:text-5xl">
              Science</router-link>
          </li>
          <li>
            <router-link ref="storyRef" to="/story" title="星星物語"
              class="font-serif tracking-wide-menu text-main-color-dark hover:text-sp-color-light duration-1000 h-table:text-8xl w-table:text-7xl large-pc:text-menu-title mobile:text-5xl screens-h-900:text-5xl">
              Story</router-link>
          </li>
          <li>
            <router-link ref="facilitiesRef" to="/facilities" title="天文設施"
              class="font-serif tracking-wide-menu text-main-color-dark hover:text-sp-color-light duration-1000 h-table:text-8xl w-table:text-7xl large-pc:text-menu-title mobile:text-5xl screens-h-900:text-5xl">
              Facilities</router-link>
          </li>
          <li>
            <router-link ref="stargazingRef" to="/stargazing" title="觀星地點"
              class="font-serif tracking-wide-menu text-main-color-dark hover:text-sp-color-light duration-1000 h-table:text-8xl w-table:text-7xl large-pc:text-menu-title mobile:text-5xl screens-h-900:text-5xl">
              Stargazing</router-link>
          </li>
          <li>
            <router-link ref="searchRef" to="/search" title="搜尋頁面"
              class="font-serif tracking-wide-menu text-main-color-dark hover:text-sp-color-light duration-1000 h-table:text-8xl w-table:text-7xl large-pc:text-menu-title mobile:text-5xl screens-h-900:text-5xl">
              Search</router-link>
          </li>
        </ul>
        ...
        <div
          ...
          <router-link v-if="hoveredAbout" to="/about"
            class="text-white absolute right-12 bottom-12 text-3xl hover:text-sub-color-light duration-1000 text-shadow">
            關於我們</router-link>
          <router-link v-else-if="hoveredScience" to="/science"
            class="text-white absolute right-12 bottom-12 text-3xl hover:text-sub-color-light duration-1000 text-shadow">
            天文科普</router-link>
          <router-link v-else-if="hoveredStory" to="/story"
            class="text-white absolute right-12 bottom-12 text-3xl hover:text-sub-color-light duration-1000 text-shadow">
            星星物語</router-link>
          <router-link v-else-if="hoveredFacilities" to="/facilities"
            class="text-white absolute right-12 bottom-12 text-3xl hover:text-sub-color-light duration-1000 text-shadow">
            天文設施</router-link>
          <router-link v-else-if="hoveredStargazing" to="/stargazing"
            class="text-white absolute right-12 bottom-12 text-3xl hover:text-sub-color-light duration-1000 text-shadow">
            觀星地點</router-link>
          <router-link v-else-if="hoveredSearch" to="/search"
            class="text-white absolute right-12 bottom-12 text-3xl hover:text-sub-color-light duration-1000 text-shadow">
            搜尋頁面</router-link>
          <router-link v-else="hoveredFacilities" to="/facilities"
            class="text-white absolute right-12 bottom-12 text-3xl hover:text-sub-color-light duration-1000 text-shadow">
            天文設施</router-link>
        </div>
      </div>
